...
#           +-------------------------+--------------------------+-----------------------+
#           |    create_acelerometro  |     String: nombre       |  - Instancia la clase |
#           |        _sensor()        |                          |    SensorAcelerometro |
#           +-------------------------+--------------------------+-----------------------+
#           |    create_temporizador  |     String: nombre       |  - Instancia la clase |
...
class SetUpSimulador:
    ...
    def main(self):
        ...
        for x in xrange(0, int(publishers)):
            ...
            print('+---------------------------------------------+')
            self.create_acelerometro_sensor(nombre)
            print('|    SENSOR DE ACELERACION   |    ASIGNADO   |')
            print('+---------------------------------------------+')
            self.create_temporizador_sensor(nombre)
            print('|    SENSOR DE TEMPORIZADOR   |    ASIGNADO   |')
            print('+---------------------------------------------+')
            print('')
            raw_input('presiona enter para continuar: ')
        print('+---------------------------------------------+')
    ...
    def create_acelerometro_sensor(self, nombre):
        s = SensorAcelerometro(nombre)
        self.sensores.append(s)

    def create_temporizador_sensor(self, nombre):
    ...
    def start_consumers(self):
        ...
        os.system(
            "gnome-terminal -e 'bash -c \"python AceleracionManager.py " + "; sleep 5 \"'")
        os.system(
            "gnome-terminal -e 'bash -c \"python TemporizadorManager.py " + "; sleep 5 \"'")
